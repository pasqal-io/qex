...
from qex.legacy.od.train import eval
...
@patch("qex.legacy.od.train.eval.kohn_sham")
...
@patch("qex.legacy.od.train.eval.get_states")
@patch("qex.legacy.od.train.eval.kohn_sham")
...
def test_kohn_sham_with_amplitude_encoding(mock_params, mock_grids, mock_neural_xc_fn):
    ...
    with patch("qex.legacy.od.train.scf.kohn_sham_amplitude_encoded") as mock_ks_amp:
...
def test_kohn_sham_without_amplitude_encoding(mock_params, mock_grids, mock_neural_xc_fn):
    ...
    with patch("qex.legacy.od.train.eval.scf_jax_dft.kohn_sham") as mock_ks:
