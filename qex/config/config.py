"""A configuration management system for QeX that makes it easy to handle settings.
...
class Config:
    """A flexible configuration manager for QeX settings.
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if default_config_path is None:
            ...
            self.default_config_path = project_path / "qex" / "config" / "default_config.yaml"
        else:
...
def setup_config(default_config_path: str | None = None) -> Config:
    ...
    Example:
        ...
        4
    """
    parser = argparse.ArgumentParser(description="QeX configuration")
