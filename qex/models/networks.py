...
from qex.models.quantum.hardware_ansatz import hea
...
class GlobalMLP(KohnShamNetwork):
    ...
    def build_network(self, grids: jnp.ndarray) -> tuple[Callable, Callable]:
        from qex.models.classical.classical_models import build_global_mlp
...
class BatchedGlobalMLP(KohnShamNetwork):
    ...
    def build_network(self, grids: jnp.ndarray) -> tuple[Callable, Callable]:
        from qex.models.classical.classical_models import build_batched_global_mlp
...
class LocalQNN(KohnShamNetwork):
    ...
    def build_network(
        ...
        from qex.models.quantum.quantum_models import build_qnn
...
class GlobalQNN(KohnShamNetwork):
    ...
    def build_network(
        ...
        Returns:
            tuple: (init_fn, apply_fn) pair of network initialization and application functions.
        """
        from qex.models.quantum.convolutional_models import build_conv_qnn
...
class GlobalQNNReverse(KohnShamNetwork):
    ...
    def build_network(
        ...
        Returns:
            tuple: (init_fn, apply_fn) pair of network initialization and application functions.
        """
        from qex.models.quantum.convolutional_models import build_conv_qnn_reverse
...
class GlobalQNNClassicalToQuantum(KohnShamNetwork):
    ...
    def build_network(
        ...
        Returns:
            tuple: (init_fn, apply_fn) pair of network initialization and application functions.
        """
        from qex.models.quantum.convolutional_models import build_conv_qnn_classical_to_quantum
...
class GlobalQNNQuantumToClassical(KohnShamNetwork):
    ...
    def build_network(
        ...
        Returns:
            tuple: (init_fn, apply_fn) pair of network initialization and application functions.
        """
        from qex.models.quantum.convolutional_models import build_conv_qnn_quantum_to_classical
...
class GlobalQiCQNN(KohnShamNetwork):
    ...
    def build_network(
        ...
        Returns:
            tuple: (init_fn, apply_fn) pair of network initialization and application functions.
        """
        from qex.models.quantum.convolutional_models import build_conv_amplitude_encoding_qnn
...
class GlobalQNNwithMLP(KohnShamNetwork):
    ...
    def build_network(self, grids: jnp.ndarray) -> tuple[Callable, Callable]:
        ...
        Returns:
            tuple: (init_fn, apply_fn) pair of network initialization and application functions.
        """
        from qex.models.quantum.convolutional_models import build_conv_mlp
